...
type Store interface {
	CreateTask(ctx context.Context, tx Transaction, supplierID, userID, productsTotal int64, ip string, uploadDate time.Time) (int64, error)
	...
	UpdateProductBufferErrorResponse(ctx context.Context, tx Transaction, products ...model.Product) (err error)
