...
func (cli *ClientJsonRPC) ABAC() *ClientABAC {
	return &ClientABAC{ClientJsonRPC: cli}
}

func (cli *ClientJsonRPC) Source() *ClientSource {
	return &ClientSource{ClientJsonRPC: cli}
}

func (cli *ClientJsonRPC) Suppliers() *ClientSuppliers {
	return &ClientSuppliers{ClientJsonRPC: cli}
}
